...
namespace Himsug_Final4.Server.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,ProductName,Unit,UnitPrice,QuantityInStock,ArrivalDate,ExpirationDate,SupplierID,is_deleted")] Product product)
        {
